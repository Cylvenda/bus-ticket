...
const BussesAvailable = () => {
    const { filteredBuses, activeBus, isSeatsOpen, openSeats, passengerRoute } = useBusBookingStore()
            ...
            <div className="mx-0 md:mx-10 mb-3 md:mb-20 flex flex-col gap-5">
                {
                    ...
                    !passengerRoute?.selectedRouteFrom || !passengerRoute?.selectedRouteTo || !passengerRoute?.selecteDate ?
                        <>
                            <EmptyState
                        ...
                        <Card className="rounded-none md:rounded-sm border-dashed border-primary">
                            <CardHeader>
                                ...
                                <CardTitle className="flex flex-row items-center gap-2 text-lg ">ROUTE: {passengerRoute?.selectedRouteFrom.toUpperCase()} <ArrowBigRightDashIcon className="fill-current " /> {passengerRoute?.selectedRouteTo.toUpperCase()}</CardTitle>
                                <CardDescription>
                                                ...
                                                <Card className="rounded-sm border-dashed border-primary flex flex-col md:flex-row items-start md:items-center justify-center px-4 md:px-8 gap-3 md:gap-10">
                                                    ...
                                                    <div className="flex flex-row gap-3 md:gap-6 items-center justify-between w-full">
                                                        ...
                                                        <div className="flex flex-col gap-4 items-center justify-center">
                                                            <p className="font-medium">TZS {Number(bus.price).toLocaleString()}</p>
